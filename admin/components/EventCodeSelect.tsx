...
// by category. If the current value isn't a standard code (a custom/legacy mapping),
// it's shown as a "(custom)" option so the value still displays and is preserved.
